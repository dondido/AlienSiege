window.onload = function () {
	...
	Game = {
		...
		init: function () {
			...
			window.addEventListener('resize', function(){Game.reflow()}, false);
			this.reflow();
		...
		displayScore: function () {
			...
			// Get the parent element, add click listener...
			...
			for (var i=this.scoreboardList.children.length,tr,entryData; i<scoreListLength; i++){
				...
				inputCheck = document.createElement("div");
				td = document.createElement("td");
				input.appendChild(inputCheck);
